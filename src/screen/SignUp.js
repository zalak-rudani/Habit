...
// import TextInputComp from '../components/TextInputComp';
// import commonStyle from '../helper/constants/commonStyle';
// import {addDetails} from '../redux/slice/studentDataSlice';
...
//     let reg = /^\d+/;
//     if (rollNo === '') {
//       setRollNoEr('enrollNum must be entered');
//     } else if (reg?.test(rollNo) === false) {
//       setRollNoEr(
//         'Please only enter numeric characters only for your enrollNum! (Allowed input:0-9)',
//       );
//     } else if (reg?.test(rollNo) === true) {
//       setRollNoEr('');
//     }
//   };
...
//             setItems={setStdData}
//             error={stdEr}
//             // onClose={() =>   stringValidation(std, setStdEr, 'Std')}
//           />
//           <DropDownComp
//             text={'Division'}
//             open={openDiv}
